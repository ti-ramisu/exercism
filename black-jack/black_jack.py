...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    ace = card_one in ace_card or card_two in ace_card
    second_card_bjk = card_one in blackjack or card_two in blackjack

    return ace and second_card_bjk
