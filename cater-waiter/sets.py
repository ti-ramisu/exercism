...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    # ingredient_list = set(dish_ingredients)
...
def tag_special_ingredients(dish):
    ...
    return dish[0], set(dish_ingredients).intersection(SPECIAL_INGREDIENTS)
...
def singleton_ingredients(dishes, intersection):
    ...
    :param intersection: constant - can be one of `<CATEGORY>_INTERSECTIONS` constants imported
     from `sets_categories_data.py`.
